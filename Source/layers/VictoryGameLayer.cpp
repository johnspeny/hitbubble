...
//VictoryGameLayer::VictoryGameLayer(const std::string& _mission)
//{
...
//}
//
//void VictoryGameLayer::displayCurrentMission()
//{
...
bool VictoryGameLayer::init() {
    ...
    retryButton->setPosition(
            Vec2(bg->getContentSize().width / 2.0f, -retryButton->getContentSize().height));
    bg->addChild(retryButton);
    ...
    ax::CallFunc *showItsChildren = ax::CallFunc::create([this]() {
        ...
        displayCurrentMission();
        auto fireworks = FireWorksParticle::create();
        fireworks->setupParticleProperties(overlayLayer, Vec2(m_visibleSize.width * 0.5f, 0),
                                           "fworks.png");
