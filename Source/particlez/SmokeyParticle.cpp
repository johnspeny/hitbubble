#include "SmokeyParticle.h"
#include "scene/GameScene.h"
#include "scene/SceneManager.h"

SmokeyParticle* SmokeyParticle::create()
{
	auto pRet = new SmokeyParticle();
	//numberOfParticles
...
void SmokeyParticle::setupParticleProperties(ax::Node* node, const ax::Vec2& position, const std::string& texturePath)
{
